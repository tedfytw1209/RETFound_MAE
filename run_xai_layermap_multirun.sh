...
bash run_xai_layermap_bs.sh  $STUDY timm_efficientnet-b4 timm_efficientnet-b4 /orange/ruogu.fang/tienyuchang/RETfound_results/${STUDY_NAME}-IRB2024_v5_all-all-timm_efficientnet-b4-OCT-bs16ep50lr5e-4optadamw-defaulteval-trsub0--/checkpoint-best.pth 380 dec weighted_sum 0.5 decoder_to_encoder 0 pre -1 -1 encoder -1 conv
