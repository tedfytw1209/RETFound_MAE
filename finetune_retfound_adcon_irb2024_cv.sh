...
Epochs=${7:-"100"}
Num_CLASS=${8:-"2"}
Eval_score=${9:-"default"}
Modality=${10:-"OCT"} # CFP, OCT, OCT_CFP
SUBSET_R=${11:-0} # 0, 1, 4
ADDCMD=${12:-""}
ADDCMD2=${13:-""}
