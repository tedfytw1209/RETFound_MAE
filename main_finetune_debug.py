...
def print_dist(data):
    train_target = np.array(data.targets)
    class_idx = [data.class_to_idx[c] for c in data.classes]
    train_weight = np.zeros(len(data.classes))
    for i in class_idx:
        train_weight[i] = np.sum(train_target == i)
    print('class dict:',data.class_to_idx)
    print('class counts:',train_weight)
...
def main(args):
    ...
    print_dist(dataset_train)
    print('val dataset:',len(dataset_val))
    print_dist(dataset_val)
    print('test dataset:',len(dataset_test))
    print_dist(dataset_test)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch_debug(
