...
class Config:
    ...
    # Paths
    CHECKPOINT_PATH = "/data/tl28853/eye/segmentation_models.pytorch/checkpoints/best_model_multiclass.pth"  # Updated checkpoint name
    INPUT_DIR = "/data/tl28853/eye/NR206/test_512"
    OUTPUT_DIR = "/data/tl28853/eye/NR206/pred_multiclass"
...
def postprocess_mask(mask_tensor, original_size):
    """Convert model output to class prediction mask"""
    # Get class predictions using argmax
    mask = torch.argmax(mask_tensor.squeeze(), dim=0).cpu().numpy()
