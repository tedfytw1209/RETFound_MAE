...
python -m torch.distributed.launch --nproc_per_node=8 --master_port=$MASTER_PORT main_finetune.py     --batch_size 16     --world_size 1     --model vit_large_patch16     --epochs 50 \
