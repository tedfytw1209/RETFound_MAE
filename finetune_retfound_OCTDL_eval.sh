...
# sbatch finetune_retfound_OCTDL_eval.sh DME_all RETFound_mae RETFound_mae_natureOCT output_dir/DME_all-OCTDL-all-RETFound_mae_natureOCT-OCT-bs16ep50lr5e-4optadamw-defaulteval--/checkpoint-best.pth 2 224 hirescam 224 /orange/ruogu.fang/tienyuchang/CellData_masks_multiclass_resnet50_new/ enc weighted_sum 0.5 decoder_to_encoder 0 pre -1 -1 encoder -1 conv
# sbatch finetune_retfound_OCTDL_eval.sh DME_all timm_efficientnet-b4 timm_efficientnet-b4 output_dir/DME_all-OCTDL-all-timm_efficientnet-b4-OCT-bs16ep50lr5e-4optadamw-defaulteval--/checkpoint-best.pth 2 224 hirescam 224 /orange/ruogu.fang/tienyuchang/CellData_masks_multiclass_resnet50_new/ enc weighted_sum 0.5 decoder_to_encoder 0 pre -1 -1 encoder -1 conv
# sbatch finetune_retfound_OCTDL_eval.sh DME_all vit-base-patch16-224 google/vit-base-patch16-224-in21k output_dir/DME_all-OCTDL-all-google/vit-base-patch16-224-in21k-OCT-bs16ep50lr5e-4optadamw-defaulteval--/checkpoint-best.pth 2 224 hirescam 224 /orange/ruogu.fang/tienyuchang/CellData_masks_multiclass_resnet50_new/ enc weighted_sum 0.5 decoder_to_encoder 0 pre -1 -1 encoder -1 conv
# sbatch finetune_retfound_OCTDL_eval.sh DME_all resnet-50 microsoft/resnet-50 output_dir/DME_all-OCTDL-all-microsoft/resnet-50-OCT-bs16ep50lr5e-4optadamw-defaulteval--/checkpoint-best.pth 2 224 hirescam 224 /orange/ruogu.fang/tienyuchang/CellData_masks_multiclass_resnet50_new/ enc weighted_sum 0.5 decoder_to_encoder 0 pre -1 -1 encoder -1 conv
