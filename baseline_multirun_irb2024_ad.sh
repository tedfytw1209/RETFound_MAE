...
#bash baseline_multirun_irb2024_ad.sh finetune_retfound_adcon_irb2024_imgf.sh vit-base-patch16-224 google/vit-base-patch16-224 5e-4 50 2 roc_auc OCT --bal_sampler
