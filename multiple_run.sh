...
do
  ...
  do
    ...
    do
      ...
      JOB_NAME="study3_${DIVIDE}${MODEL_NAME}${NUM_CLASS}${PROXIMAL}"
      echo $JOB_NAME
      # Submit the job to Slurm
      sbatch --job-name="$JOB_NAME" finetune_retfound_study.sh study3 $MODEL_NAME $NUM_CLASS $DIVIDE $num_k $PROXIMAL
    done
  done
done