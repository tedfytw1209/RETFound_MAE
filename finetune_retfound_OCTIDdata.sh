...
#cd $HOME
STUDY=$1 #DR_all 2, CSR_all 2, MH_all 2
...
NUM_K=0
data_type="OCTID"
IMG_Path="/orange/ruogu.fang/tienyuchang/OCTID"
Epochs=15
...
# sbatch finetune_retfound_OCTIDdata.sh DR_all RETFound_mae RETFound_mae_natureOCT 5e-4 2 0.05 roc_auc OCT
