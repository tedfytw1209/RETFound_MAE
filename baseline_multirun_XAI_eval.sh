...
do
    ...
    do
        ...
        echo "bash $SCRIPT $DATASET $MODEL $FINETUNED_MODEL output_dir/$DATASET-IRB2024_v5-all-$FINETUNED_MODEL-OCT-bs16ep50lr5e-4optadamw-defaulteval-trsub0---add_mask---train_no_aug/checkpoint-best.pth $NUM_CLASS $XAI"
        bash $SCRIPT $DATASET $MODEL $FINETUNED_MODEL output_dir/$DATASET-IRB2024_v5-all-$FINETUNED_MODEL-OCT-bs16ep50lr5e-4optadamw-defaulteval-trsub0---add_mask---train_no_aug/checkpoint-best.pth $NUM_CLASS $XAI
    done
done
