...
""" ReLayNet for classification task 
From: https://github.com/ai-med/relaynet_pytorch/tree/master/relaynet_pytorch/net_api
...
def ReLayNet(**kwargs):
    ...
    model = ReLayNetClassifier(params, **kwargs)
    return model

def relynet_load_pretrained(model,path,device):
