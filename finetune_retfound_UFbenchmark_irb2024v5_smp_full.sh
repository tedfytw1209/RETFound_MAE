...
# sbatch finetune_retfound_UFbenchmark_irb2024v5_smp_full.sh DME_binary_all_split SMP /blue/ruogu.fang/tienyuchang/RETFound_MAE/Seg_checkpoints/best_model_multiclass.pth 1e-4 2 1e-4 default OCT 0 fuse weighted_sum 0.5 decoder_to_encoder 0 post -1 -1 linear --smp_learnable_alpha
...
# sbatch finetune_retfound_UFbenchmark_irb2024v5_smp_full.sh AMD_all_split SMP /blue/ruogu.fang/tienyuchang/RETFound_MAE/Seg_checkpoints/best_model_multiclass_resnet50_new.pth 1e-4 2 1e-4 default OCT 0 fuse multiply 0.5 decoder_to_encoder 9 pre -2 -1 conv --seg_mask
