...
# sbatch finetune_retfound_Celldata.sh AMD_all vit-base-patch16-224 google/vit-base-patch16-224-in21k 5e-5 2 0.01 roc_auc OCT
# sbatch finetune_retfound_Celldata.sh DME_all RETFound_mae RETFound_mae_natureOCT 5e-4 2 0.05 roc_auc OCT
