...
do
    ...
    echo "sbatch $SCRIPT $DATASET $MODEL_DIR/$DATASET-IRB2024_v5-all-RETFound_mae_natureOCT-OCT-bs16ep50lr5e-4optadamw-roc_auceval-trsub${SUBSETNUM}--/checkpoint-best.pth $MODEL_DIR/$DATASET-IRB2024_v5-all-RETFound_mae_natureCFP-CFP-bs16ep50lr5e-4optadamw-roc_auceval-trsub${SUBSETNUM}--/checkpoint-best.pth $LR $NUM_CLASS $weight_decay $Eval_score $Modality $SUBSETNUM"
