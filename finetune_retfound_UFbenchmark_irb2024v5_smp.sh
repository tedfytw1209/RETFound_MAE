...
# sbatch finetune_retfound_UFbenchmark_irb2024v5_smp.sh DME_binary_all_split SMP /blue/ruogu.fang/tienyuchang/RETFound_MAE/Seg_checkpoints/best_model_multiclass.pth 1e-4 2 1e-4 default OCT 0 enc weighted_sum 0.5 decoder_to_encoder --add_mask --train_no_aug --smp_learnable_alpha
